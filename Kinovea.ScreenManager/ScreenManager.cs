...
namespace Kinovea.ScreenManager
{
    public class ScreenManagerKernel : IKernel
    {
        ...
        private IEnumerable<CombinedScreen> combinedScreens;
        ...
        public ScreenManagerKernel()
        {
            ...
            combinedScreens = screenList.Where(s => s is CombinedScreen).Select(s => s as CombinedScreen);
        ...
        private void AddScreenEventHandlers(AbstractScreen screen)
        {
            ...
            if (screen is PlayerScreen playerScreen)
                AddPlayerScreenEventHandlers(playerScreen);
            else if (screen is CaptureScreen captureScreen)
                AddCaptureScreenEventHandlers(captureScreen);
            else if (screen is CombinedScreen combinedScreen)
                AddCombinedScreenEventHandlers(combinedScreen);
        }
        ...
        private void AddCombinedScreenEventHandlers(CombinedScreen screen)
        {
            // Add event handlers for the embedded CaptureScreen
            AddCaptureScreenEventHandlers(screen.CaptureScreen);

            // Add event handlers for the embedded PlayerScreen
            AddPlayerScreenEventHandlers(screen.PlayerScreen);
        }
        ...
        private void RemoveScreenEventHandlers(AbstractScreen screen)
        {
            ...
            if (screen is PlayerScreen)
                ...
                RemoveCombinedScreenEventHandlers(combinedScreen);
        ...
        private void RemoveCombinedScreenEventHandlers(CombinedScreen screen)
        {
            // Remove event handlers for the embedded CaptureScreen
            RemoveCaptureScreenEventHandlers(screen.CaptureScreen);

            // Remove event handlers for the embedded PlayerScreen
            RemovePlayerScreenEventHandlers(screen.PlayerScreen);
        }
