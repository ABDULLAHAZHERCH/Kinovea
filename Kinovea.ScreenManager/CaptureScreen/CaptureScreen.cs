...
namespace Kinovea.ScreenManager
{
    ...
    public class CaptureScreen : AbstractScreen
    {
        ...
        public CaptureScreenView View
        {
            get { return view as CaptureScreenView; }
        }
        public CameraSummary Csummary
        {
            get { return cSummary; }
        }
        public ScreenDescriptionCapture SDcapture
        {
            get { return cSdescription; }
        }
        public string recentFileName
        {
            get { return bigFileName; }
        }

        public bool recorded1time
        {
            get { return oneTimeRecorded; }
            set { oneTimeRecorded = value; }
        }
        public bool loaded
        {
            get { return cameraLoaded; }
            set { cameraLoaded = value; }
        }
        ...
        private bool oneTimeRecorded = false;
        private CameraSummary cSummary;
        private ScreenDescriptionCapture cSdescription;
        ...
        private void AfterStopRecording(string finalFilename)
        {
            if (recordingThumbnail != null)
            {
                ...
                bigFileName = finalFilename; // save filename for player
                oneTimeRecorded = true; // state management for autoplay
                recordingThumbnail.Dispose();
                recordingThumbnail = null;
            }
            ...
            //LoaderVideo.LoadVideo(SinglePlayer.Instance.PlayerScreen, finalFilename, null);
            ...
            {
                log.Error("Error loading video after recording: " + ex.Message);
            }
