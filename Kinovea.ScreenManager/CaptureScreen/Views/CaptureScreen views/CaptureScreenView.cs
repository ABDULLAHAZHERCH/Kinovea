...
namespace Kinovea.ScreenManager
{
    ...
    public partial class CaptureScreenView : KinoveaControl, ICaptureScreenView
    {
        ...
        private void BtnRecordClick(object sender, EventArgs e)
        {
            ...
            Task.Delay(200).ContinueWith(t =>
            {
                this.BeginInvoke(new Action(() =>
                {
                    ...
                    else if (!playauto && presenter.recorded1time)
                    {
                        callPlayer();
                    }
                }));
        ...
        private void sldrDelay_Click(object sender, EventArgs e)
        {
        ...
        private void fnbImage_Load(object sender, EventArgs e)
        {
